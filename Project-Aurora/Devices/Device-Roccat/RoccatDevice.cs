...
namespace Device_Roccat
{
    public class RoccatDevice : Device
    {
        ...
        public override bool Initialize()
        {
            ...
            {
                LogError("Could not Enter Ryos SDK Mode");
                return isInitialized = false;
            }
        ...
        public override bool UpdateDevice(Dictionary<DeviceKeys, Color> keyColors, DoWorkEventArgs e, bool forced = false)
        {
            ...
            if (enable_ryos)
            {
                ...
                {
                    if (KeyMap.DeviceKeysMap.TryGetValue(LocalizeLayout(key.Key), out var k))
                    {
                        colorStruct[k] = ToRoccatColor(key.Value);
                        stateStruct[k] = IsLedOn(key.Value);
                    }
                }
                ryosTalkFx.SetMkFxKeyboardState(stateStruct, colorStruct, (byte)GetLayout());
            }
        ...
        private DeviceLayout GetLayout()
        {
        ...
        private DeviceKeys LocalizeLayout(DeviceKeys Key)
        {
