...
namespace Aurora.Profiles
{
    ...
    public class LocalPCInformation : Node<LocalPCInformation> {
        ...
        public int DS4Battery => Global.dev_manager.InitializedDevices.OfType<Devices.Dualshock.DualshockDevice>().FirstOrDefault()?.Battery ?? 0;

        public bool DS4Charging => Global.dev_manager.InitializedDevices.OfType<Devices.Dualshock.DualshockDevice>().FirstOrDefault()?.Charging ?? false;
